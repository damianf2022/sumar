...
const Electrogenogas = () => {
    return (
        <div className='trogenocontaniner'>
            ...
            <h4><strong>Grupos electrógenos</strong> a gas</h4>
            ...
            <img className='trogenocontaniner2' src="https://sumarservicios.com.ar/wp-content/uploads/2020/01/Grupos-electrogenos_alternadores.jpg" alt="" />
        </div>
    )
}
